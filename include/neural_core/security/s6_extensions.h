#ifndef ARIX_S6_EXTENSIONS_H
#define ARIX_S6_EXTENSIONS_H
...
#define ARIX_SHAMIR_MAX_SHARES 16
#define ARIX_SHAMIR_MIN_SHARES 5
...
int  arix_policy_dsl_init(ArixPolicyDSL* dsl);
