 ...
 * Intended as a starting point for users exploring the library.
 */
...
int main(void) {
    ...
    printf("  3. Training loop with loss tracking\n");
    printf("  4. Checkpoint save/load\n\n");
    printf("Not yet implemented — check back at v0.5\n");
    return 0;
}
